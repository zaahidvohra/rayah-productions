        ...
        <div className="max-w-4xl px-6">
          ...
          {showButtons && (
            <div className="space-x-4 animate-fade-in-up animation-delay-400">
              <Link to="/portfolio" className="bg-accent-dark hover:bg-primary text-white px-6 py-3 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg border-2 border-transparent hover:border-accent-light">
                View Portfolio
              </Link>
              <Link to="/contact" className="border-2 border-accent-light text-accent-light hover:bg-accent-light hover:text-text-primary px-6 py-3 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 backdrop-blur-sm">
                Contact Us
              </Link>
            </div>
          )}
