...
<div className="h-96 md:h-[500px] lg:h-[600px] w-full flex items-center justify-center overflow-hidden bg-secondary perspective-[1000px]">      
      {/* INCREASED SIZES:
          ...
          Lg: w-[240px] h-[240px]
      */}
      <div className="relative lg:w-[240px] lg:h-[240px] md:w-[200px] md:h-[200px] sm:w-[160px] sm:h-[160px] w-[140px] h-[140px] [transform-style:preserve-3d] animate-[rotate_30s_linear_infinite]">
