...
const ContactForm = ({ formConfig }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "❌ Sorry, there was an error sending your message. Please contact us directly at amit@gmail.com or try again later."
      );
    } finally {
  ...
  return (
    <div className="lg:sticky lg:top-8">
      <div className="bg-white rounded-3xl shadow-2xl border border-accent-light/30 overflow-hidden">
        {/* Form Header */}
        <div className="bg-primary from-primary to-accent-dark p-8 text-white">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="font-body text-accent-light/90">
                {formConfig.subtitle}
              </p>
            </div>
          </div>
        ...
        <div className="p-8">
          <div className="space-y-6">
            ...
            <button
              ...
              className="bg-primary text-white px-8 py-4 rounded-lg hover:bg-opacity-90 transition-colors font-medium flex items-center justify-center space-x-2 w-full disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
