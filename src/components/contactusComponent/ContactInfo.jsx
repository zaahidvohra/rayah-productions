                ...
                <div className="flex gap-4">
                    {contactInfo.socialLinks.map((link, index) => (
                        <a
                            ...
                            className={`w-12 h-12 bg-gradient-to-r ${link.color} rounded-xl flex items-center justify-center hover:scale-110 transition-transform duration-300 shadow-lg`}
                        >
